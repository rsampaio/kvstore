/*
Package kvstore is a simple key value store that listens on TCP and TLS sockets and is intended to excercise software development and demonstrate the design and the use of documentation, tests and benchmarks in Go projects.
